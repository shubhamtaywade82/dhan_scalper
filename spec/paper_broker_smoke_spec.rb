...
RSpec.describe "Paper Broker Smoke Tests" do
  ...
  describe "profit round trip" do
    it "executes BUY 75 @100 → SELL 75 @120 correctly" do
      # BUY 75 @100
  ...
  describe "loss round trip" do
    it "executes BUY 75 @100 → SELL 75 @90 correctly" do
      # BUY 75 @100
      buy_result = broker.buy_market(
        segment: "NSE_FNO",
        security_id: "TEST_CE_100",
  ...
  describe "partial exit / averaging" do
    it "handles BUY 75 @100 → BUY 75 @120 → SELL 75 @130 correctly" do
      # BUY 75 @100
  ...
  describe "insufficient funds rejection" do
    it "rejects BUY when balance is insufficient" do
      # Set tiny balance
  ...
  describe "oversell rejection" do
    it "rejects SELL when quantity exceeds position" do
      # BUY 75 @100
      buy_result = broker.buy_market(
        segment: "NSE_FNO",
        security_id: "TEST_CE_100",
  ...
  describe "equity invariant" do
    it "has equity equal to balance when flat" do

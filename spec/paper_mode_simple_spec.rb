...
RSpec.describe "Paper Mode Simple Test Suite" do
  let(:config) do
    {
      global: {
  ...
  before do
    ...
    allow(mock_ws_manager).to receive(:set_active_instruments_provider)
    ...
    allow(mock_position_tracker).to receive(:get_underlying_summary).and_return({})
  ...
  describe "Paper Mode Initialization" do
    ...
    it "initializes components correctly" do
      expect(paper_app.instance_variable_get(:@websocket_manager)).not_to be_nil
      expect(paper_app.instance_variable_get(:@position_tracker)).not_to be_nil
      expect(paper_app.instance_variable_get(:@balance_provider)).not_to be_nil
      expect(paper_app.instance_variable_get(:@broker)).not_to be_nil
    end
  ...
  describe "Configuration and Setup" do
    ...
    it "initializes quantity sizer" do
      ...
      expect(quantity_sizer).not_to be_nil
    end
  ...
  describe "Risk Management" do
    it "checks daily loss limits" do
      ...
      expect(paper_app).to receive(:puts).with(/Stopping trading for today/)
  ...
  describe "Integration Tests" do
    it "integrates all components correctly" do
      ...
      expect(paper_app.instance_variable_get(:@balance_provider)).not_to be_nil
      expect(paper_app.instance_variable_get(:@broker)).not_to be_nil
      expect(paper_app.instance_variable_get(:@csv_master)).not_to be_nil
      expect(paper_app.instance_variable_get(:@picker)).not_to be_nil
      expect(paper_app.instance_variable_get(:@trend)).not_to be_nil
    end
    ...
    it "maintains state consistency" do
      ...
      expect(initial_state).not_to be_nil
